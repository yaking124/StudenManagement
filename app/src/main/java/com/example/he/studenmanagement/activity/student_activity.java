                        ...
                        if (!TextUtils.isEmpty(first) && !TextUtils.isEmpty(second)) {
                            if (first.matches("[0-9]{6}") && second.matches("[0-9]{6}")) {
                                if (second.equals(first)) {
                                    ...
                                    Toast.makeText(student_activity.this, "密码修改成功", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(student_activity.this, "两次密码不一致", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(student_activity.this, "密码必须为6位数字", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(student_activity.this, "密码不能为空", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                builder.create().show();
